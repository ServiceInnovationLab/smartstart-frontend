...
const fields = {
  'mother.firstNames': {
    ...
    instructionText: "Enter all the mother's current first and middle names. If the names were different at birth, you can enter them below.",
  ...
  'mother.surnameAtBirth': {
    ...
    instructionText: "You only need to complete this section if the mother's surname at birth is different to their current name. If she is using a married name, enter her maiden name here. If the mother was adopted, please enter the surname given after adoption.",
  ...
  'mother.citizenshipSource': {
    ...
    label: makeMandatoryLabel(`Please indicate how the mother is a New Zealand citizen?`),
