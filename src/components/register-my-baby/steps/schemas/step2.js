...
const fields = {
  ...
  'mother.firstNamesAtBirth': {
    ...
    instructionText: "You only need to complete this section if the mother's first names at birth are different from her current names (as above). If the mother was adopted, please enter the names she was given after she was adopted.",
  ...
  'mother.surnameAtBirth': {
    ...
    instructionText: "You only need to complete this section if the mother's surname at birth is different to her current name. If she is using a married name, enter her maiden name here. If the mother was adopted, please enter the surname she was given after she was adopted.",
