...
class SiteMetadataCard extends Card {
  render () {
    ...
    if (tags.indexOf('boac_presentation::contact') > -1) {
      logos.push(<img key='logo-dia' src='/assets/img/dia-logo.svg' className='logo-dia' alt='Department of Internal Affairs' />)
      logos.push(<img key='logo-msd' src='/assets/img/msd-logo.svg' alt='Ministry of Social Development' />)
      logos.push(<img key='logo-ird' src='/assets/img/ird-logo.png' className='logo-moh' alt='Inland Revenue' />)
